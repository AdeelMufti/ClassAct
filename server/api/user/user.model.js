...
var authTypes = ['facebook'/*, 'twitter', 'google'*/];
...
var fieldAccessByUserRole = {
  default: ['name','email','role','permanent','approved','created','createdIpAddress','verified','language','provider','facebook','emailSubscriptions'],
}
fieldAccessByUserRole.admin = fieldAccessByUserRole.default;
