...
angular.module('classActApp', [
  ...
  .config(['$translateProvider','translations', function ($translateProvider, translations) {
    ...
    translations['en'] = {
      ...
      CLASSIFIED_SUBMITTED_POSTED: "Your classified has been submitted and posted.",
      CLASSIFIED_SUBMITTED_NOT_POSTED: "Your classified has been submitted. It will be posted when it is approved by an administrator.",
    ...
    translations['fr'] = {
      ...
      CLASSIFIED_SUBMITTED_POSTED: "Votre annonce a été soumise et publiée",
      CLASSIFIED_SUBMITTED_NOT_POSTED: "Votre annonce a été soumise. Elle sera affichée quand elle est approuvée par un administrateur.",
